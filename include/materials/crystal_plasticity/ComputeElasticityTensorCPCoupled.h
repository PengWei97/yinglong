...
/**
 * ComputeElasticityTensorCPCoupled defines an elasticity tensor material
 ...
 */
class ComputeElasticityTensorCPCoupled : public ComputeElasticityTensor
{
public:
  static InputParameters validParams();

  ComputeElasticityTensorCPCoupled(const InputParameters & parameters);
...
protected:
  ...
  const VariableValue & _euler_angle1;
  const VariableValue & _euler_angle2;
  const VariableValue & _euler_angle3;
};
