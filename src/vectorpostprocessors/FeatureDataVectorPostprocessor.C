...
registerMooseObject("yinglongApp", FeatureDataVectorPostprocessor);
...
FeatureDataVectorPostprocessor::FeatureDataVectorPostprocessor(const InputParameters & parameters)
...
void
FeatureDataVectorPostprocessor::accumulateVolumes(const Elem * elem,
